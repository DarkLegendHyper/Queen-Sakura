...
console.log(color(figlet.textSync('Queen Sakura Bot', {
		font: 'Pagga',
...
store.bind(A17.ev)
    ...
    A17.sendMessage(callerId, { text: `🧚‍♂️┃! You will be blocked automatically for calling me!`}, { quoted : pa7rick })
    await sleep(8000)
...
I am *Queen Sakura Bot*, Welcome to ${metadata.subject}.
