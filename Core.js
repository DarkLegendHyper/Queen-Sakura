...
if (smallinput.includes('hello')) {
  reply (`🧚‍♂️┃👋 *හායී අලෝ* ${pushname}, 🧚‍♂️• ${BotName}. 👋 *කොහොමද ඔයාට මැණික මම තමා* *Queen-Sakura* *ඔයා කවුද අනේ* 🤭`);
} 

//if (smallinput.includes('hi')) {

//   reply (`🧚‍♂️┃👋හායී ${pushname}, මම ${BotName}. *හායී මැණික මොකද කරන්නේ ඉතින්* 🤭`);

// } 

if (smallinput=='bot') {
    reply (`🧚‍♂️┃ _*HI*_ I AM •━ _*QUEEN-SAKURA-MD*_ on Whatsapp © *Created by*: *M,R SUNETH* `)
}
...
if (smallinput=='.alive') {
    reply ('🧚‍♂️┃ _*HI*_ I AM *QUEEN-SAKURA-MD* ⏳ Please Type the *.menu* and generatied in QUEEN-SAKURA-MD Command list 🧚‍♂️┃${pushname},┃🧚‍♂️')
}

if (smallinput=='sakurabase') {
  reply ('🧚‍♂️┃ *Hello I am* *QUEEN-SAKURA MD database on* =🧚‍♂️ *QUEEN-NETHU-MD* 🧚‍♂️'')
}

if (smallinput=='ping') {
    reply (`🧚‍♂️┃ *HI* ${pushname} *Pong* ${latensie.toFixed(4)} ms ⏳ *Queen-Sakura* *speed pings*`)
}


if (smallinput.includes('good morning') || smallinput.includes('ohayo')) {
  reply (`👋 _*ගුට් මෝනිම් අලෝ*_ ${pushname} ☀️. .`);
}
...
if (smallinput.includes('arigato')|| smallinput.includes('arigatou') || smallinput.includes('thank')) {
  reply (`Mention not ${pushname} 😇. I am a bot afterall.`);
    ...
    let { data } = await axios.get('https://api.github.com/blacksyberzizuko/Queen-Sakura');
    teks = `*Queen-Sakura Script*\n\n*Total Stars*: ${data.stargazers_count}⭐\n*Total Forks*: ${data.forks_count} forks\n*GitHub*: https://github.com/Kai0071/A17\n\nDont forget to follow me on *GitHub* and give a ⭐️ to my projects. `
  /*  let buttons = [
   ...
   /* footer: `${BotName}`,
    ...
    title:"Powered by SUNETH",
    body: " ", 
    thumbnail: fs.readFileSync("Assets/pic4.jpg"),
    mediaType:1,
    //mediaUrl: 'https://wallpapercave.com/wp/wp10524580.jpg',
    //sourceUrl: "https://wallpapercave.com/wp/wp10524580.jpg"
    mediaUrl: 'github.com/blacksyberzizuko/Queen-Sakura',
    sourceUrl: "github.com/blacksyberzizuko/Queen-Sakura"
    }}
    ...
    case 'support': case 'supportgc': {
      A17.sendMessage(from, { react: { text: "💫" , key: m.key }})
    reply(`••━┃QUEEN-SAKURA SUPPORT GROUP┃━•• =https://chat.whatsapp.com/KUwc3H3tUZNHcmionwhqbi`)
    }
    break
...
case 'repo': case 'botrepo': {
  A17.sendMessage(from, { react: { text: "💫" , key: m.key }})
    reply(`⚙ My Source Code is </> - https://github.com/blacksyberzizuko/Queen-Sakura 🧚‍♂️`)
    }
    break
    ...
    case 'owner': case 'creator': case 'mod': case '🎮': case 'mods': {
      ...
      case 'public': {
        ...
        A17.setStatus(`🧚‍♂️┃ _*HI*_ I *AM* *QUEEN-SAKURA* *WHATSAPP BOT* ⏳ *please*  *Don t call and spam me* 🤒..*and* *QUEEN-SAKURA* *PUBLIC* *BOT* 👋`)
        }
        break
      ...
      return cpu
        ...
        respon = `
*QUEEN-SAKURA Speed* ${latensi.toFixed(4)} _*Second*_ \n ${oldd - neww} _*miliseconds*_\n\nRuntime : ${runtime(process.uptime())}
» sakura's Server Info 
...
if (!q) reply(`🧚‍♂️┃ *Example :* ${prefix + command} 🤨+🤒`)
...
var nsfwdata = JSON.parse(fs.readFileSync('./HostMedia/nsfw/pussy.jahy'))
var kairesult = pickRandom(nsfwdata)
A17.sendMessage(m.chat, { caption: mess.success, image: { url: kairesult.url } }, { quoted: m })
break
...
if (!args.join(" ")) return reply('🧚‍♂️┃🤨Where is the emoji?')
emoji.get(args.join(" ")).then(async(emoji) => {
let mese = await A17.sendMessage(m.chat, {image:{url:emoji.images[4].url}, caption: `Here it is...`}, {quoted:m})
await A17.sendMessage(from, {text:"🧚‍♂️┃reply -s to this image to make sticker"}, {quoted:mese})
})
}
break
...
if (!m.quoted) return reply('🧚‍♂️┃Please mention a message 🪄')
...
case 'ghstalk': case 'githubstalk': case'github': {
  ...
  if (!q) return replay(`Give me a user name like *${prefix}github blacksyberzizuko*`)
  ...
  🧩 Created At : ${gitdata.ceated_at}` }, { quoted: m } )
  }
  break
...
let teks = ` 「  Queen-Skura pm user list  」\n\nTotal ${anu.length} users are using sakura in personal chat.`
for (let i of anu) {
...
let teks = ` 「  Queen-Sakura group user list  」\n\nTotal ${anu.length} users are using bot in Groups.`
for (let i of anu) {
...
case 'speedtest': case 'speedcheck': {
  A17.sendMessage(from, { react: { text: "🫡" , key: m.key }})
   ...
   m.reply(`Plz Wait ${pushname} Testing QUEEN-SAKURAA Speed... ⚙️`)
...
case 'status': case 'post': {
  ...
  if (!quoted) return replay(`🧚‍♂️┃Send/Reply Image With Caption ${prefix}status`)
  if (/video/.test(mime)) {
      if ((quoted.msg || quoted).seconds > 30) return reply('🧚‍♂️┃Maximum 30 seconds video is allowed!')
  }
...
if (isBanChat) return reply(mess.bangc)
A17.sendMessage(from, { react: { text: "📩" , key: m.key }})
if (!args.join(" ")) return replay(`Example : ${prefix + command} free fire`)
...
await A17.updateBlockStatus(users, '🧚‍♂️┃block').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
break
...
A17.sendMessage(from, { react: { text: "👋" , key: m.key }})
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await A17.updateBlockStatus(users, '🧚‍♂️┃unblock').then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
}
break
...
if (!isAdmins && !isCreator) return replay(mess.useradmin)
A17.sendMessage(from, { react: { text: "⚒️" , key: m.key }})
if (!text) return replay('🧚‍♂️┃Pls enter -setname <New Group Description>  to change this Group Description.')
...
if (!isAdmins && !isCreator) return replay(mess.useradmin)
A17.sendMessage(from, { react: { text: "🍃" , key: m.key }})
if (!quoted) return replay(`🧚‍♂️┃Send/Reply Image With Caption ${prefix + command}`)
if (!/image/.test(mime)) return replay(`🧚‍♂️┃Send/Reply Image With Caption ${prefix + command} to change the Profile Pic of this group.`)
if (/webp/.test(mime)) return replay(`🧚‍♂️┃Send/Reply Image With Caption ${prefix + command} to change the Profile Pic of this group.`)
...
A17.sendMessage(from, { react: { text: "🤴" , key: m.key }})
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await A17.groupParticipantsUpdate(m.chat, [users], '🧚‍♂️┃promote').then((res) => replay(jsonformat(res))).catch((err) => replay(jsonformat(err)))
}
break
...
A17.sendMessage(from, { react: { text: "🤷‍♀️" , key: m.key }})
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await A17.groupParticipantsUpdate(m.chat, [users], '🧚‍♂️┃demote').then((res) => replay(jsonformat(res))).catch((err) => replay(jsonformat(err)))
}
break
...
if (!isCreator) return replay(mess.botowner)
A17.sendMessage(from, { react: { text: "😒" , key: m.key }})
if (!args[0]) return replay(`🧚‍♂️┃Where's the link?`)
vdd = args[0]
let vcc = vdd.split("https://chat.whatsapp.com/")[1]
if (!vcc) return replay("🧚‍♂️┃Link invalid!")
if (isCreator) {
...
if (sizny < 20) {
teks = `🧚‍♂️┃Sorry, munimun 20 members are required in a group to add bot!`
...
case 'leavegc': case 'leavegroup': case 'bye': {
  ...
  if (!m.isGroup) return replay(mess.grouponly)
      reply(mess.waiting)
                  if (!isCreator) return replay(`bye😒${mess.botowner}`)
...
case 'ringtone': {
  ...
  A17.sendMessage(m.chat, { audio: { url: result.audio }, fileName: result.title+'.mp3', mimetype: 'audio/mpeg' }, { quoted: m })
    ...
    reply("🧚‍♂️┃Please send video/audio file only!")
    }
    }
    break
...
case 'tempo': {
  if (isBan) return reply(mess.banned)
  if (isBanChat) return reply(mess.bangc)
  if (!args.join(" ")) return reply(`Example: ${prefix + command} 1`)
  var req = args.join(' ')
  ...
  case 'bass': case 'blown': case 'deep': case 'earrape': case 'fast': case 'fat': case 'nightcore': case 'reverse': case 'robot': case 'slow': case 'smooth': case 'tupai':
      ...
      } else reply(`🧚‍♂️┃please  mention any audio you want to modify _${prefix + command}_`)
      } catch (e) {
      reply(e)
      }
      break
...
if (!/webp/.test(mime)) return reply(`🧚‍♂️┃Reply sticker with caption *${prefix + command}*`)
reply(mess.waiting)
let media = await A17.downloadAndSaveMediaMessage(quoted)
...
reply(mess.waiting)	
       ...
       let anu = await maker.textpro(link, q)
          A17.sendMessage(m.chat, { image: { url: anu }, caption: `Made by Queen-Sakura Bot By sunethi...  🪄` }, { quoted: m })
       }
...
case "tts":  case "texttospeech":  case "say": case "speak":{
  ...
  if (!args[0]) return reply("🧚‍♂️┃Please give me a text so that i can speak it!")
    ...
    A17.sendMessage(m.chat,{audio: {url: texttospeechurl,},mimetype: "audio/mpeg",fileName: `SAKURASpeechEngine.mp3`,},{quoted: m,});
  }
  break;
...
if (isBanChat) return reply(mess.bangc)
       ...
       let bocil = require('@bochilteam/scraper')  
           bocil.facebookdlv2(`${text}`).then(async (data) => {                   
               ...
               txt += `🏷️*Description:* ${data.description}\n`
               txt += `🖇️*URL :* ${text}\n\n`
           buf = await getBuffer(data.thumbnail)    
           A17.sendMessage(m.chat, { image: { url: data.thumbnail }, jpegThumbnail:buf, caption: `${txt}` }, { quoted: m })         
...
case 'yts': case 'ytsearch': {
 ...
 let teks = '```「Sakura YouTube search」```\n\n 🔍Search Term: '+text+'\n\n'
 let no = 1
...
A17.sendMessage(from, {video:{url:ytmp4play.videoUrl}, mimetype:"video/mp4", caption:anu.title+' By ꜱᴀᴋᴜʀᴀ-ᴍᴅ',}, {quoted:m})
}
...
A17.sendMessage(from, {video:{url:ytmp4play2.videoUrl}, mimetype:"video/mp4", caption:'Downloaded by Qᴜᴇʀɴ-ꜱᴀᴋᴜʀᴀ',}, {quoted:m})
}
break
...
A17.sendMessage(from, { react: { text: "🤧" , key: m.key }})
        ...
        if (!text) return replay(`Tag Someone, Example : ${prefix + command} @sakura`)
...
case 'anime': {
  ...
  reply(mess.waiting);
          ...
          if (!anime) return replygcxeon(`${p}Could not find your scarch`)
  let animetxt = `
  🎀 *Title: ${anime.title}*
  🎋 *Type: ${anime.type}*
...
┗━━━━━━━❖┃••
┏━━━━━━━━━━━━━━━━━━••
┃🍁 ʙᴏᴛ ɴᴀᴍᴇ   : Qᴜᴇᴇɴ-ꜱᴀᴋᴜʀᴀ
┃🔱 ᴜꜱᴇʀ ɴᴀᴍᴇ :* ${pushname} 
┃📍 ʙᴏᴛ ᴘʀᴇꜰɪx  :*  ${prefix}
┃👤 ʙᴏᴛ ᴏᴡɴᴇʀ  :* ${global.OwnerName} 
┃⚡ ʙᴏᴛ ꜱᴘᴇᴇᴅꜱ :* ${latensie.toFixed(4)} ms 
┃🫂 ʙᴏᴛ ᴜꜱᴇʀꜱ  :* ${Object.keys(global.db.users).length}
┃📟 ʀᴜɴ ᴛɪᴍᴇꜱ  :* ${runtime(process.uptime())} 
┃🧬 ꜱᴏꜰᴛᴡᴇᴀʀᴇ  :* Linux 
┗━━━━━━━❖┃••
┏━━━━━━━━━━━━━━━━━━••
...
┃┗━━━━━━━❖┃••
┃🍃${pushname} 
┃©https://github.com/blacksyberzizuko/Queen-Sakura
┗━━━━━━━━━━━━━━━━━━••`
            let buttonMessage = {
                        video:fs.readFileSync('./system/QueenSakura1.mp4'),gifPlayback:true,
                        caption: helpmenu,
    ...
    case '':
     ...
     reply(`🧚‍♂️┃Do you need any help ${pushname} ? Type *${prefix}help* to get my full command list.`)
        }
...
A17.sendMessage(from, { react: { text: "🌀" , key: m.key }})
  ...
  reply(`🧚‍♂️┃Running repl....Please wait until repl.it responds...`)						
  var replqr =  await getBuffer(`https://a17-qr-scanner.broken0007.repl.co/`)
        ...
        let bmffg = {
         image: replqr,
         caption:  `🧚‍♂️┃Scan the qr within 10-15 seconds...`,
    /*    footer: `${global.BotName}`,
        buttons: qrbutton,
        headerType: 4 */
        }     
